...
def get_folder_list(mother: str = "."):
    """
...
def create_idx_path(mother: str, suffix: str=""):
...
def get_run_scan_directory(mother: str, run: int, scan: int = None, file_num: int = None) -> str:
    """
...
def format_run_scan_filename(run: int, scan:int = None, file_num:int = None) -> str:
    """
...
def get_roi_list(mother: str) -> RoiRectangle:
...
def get_ooi(mother: str) -> list[RoiRectangle]:
...
def get_sigma_factor(mother: str) -> float:
...
def save_roi_list(mother: str, roi_rect_list: list[RoiRectangle]):
...
def save_ooi(mother: str, ooi_rect: RoiRectangle):
...
def mat_to_ndarray(run: int, scan: int):
